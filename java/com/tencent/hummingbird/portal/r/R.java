package com.tencent.hummingbird.portal.r;
...
public class R<T> implements Serializable {
    ...
    public static R ok(String message){
     ...
     /* public R setCode(int code){  ===>Accessors(chain=true)
        this.code=code;
        return this;
    }*/
    /**
    ...
    /**
     在SystemController类中注册学生的方法要返回R类的对象
     方法修改为
     重启服务
     从新提交注册信息,页面上会显示R类json格式信息
     使用QueryWrapper完成对数据库的操作
     QueryWrapper是MybatisPlus提供的一个类
     这个类中可以设置查询条件
     实现程序员不写sql语句就能实现数据库查询操作的功能
     在测试类中编写代码如下
     * 当创建一个对象时，发生一个验证错误。
     */
